...
from Constants import NO_OF_CELLS_COL, NO_OF_CELLS_ROW, BANNER_HEIGHT, USER_SEED
import numpy as np
...
class GA(Algorithm):
    ...
    def died(self, snake):
        ...
        elif not 0 <= current_x < NO_OF_CELLS_ROW or not BANNER_HEIGHT <= current_y < NO_OF_CELLS_COL:
            self.population.remove(snake)
