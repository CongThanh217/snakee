...
class DFS(Algorithm):
    ...
    def recursive_DFS(self, snake, goalstate, currentstate):
        ...
        for neighbor in neighbors:
            if not self.inside_body(snake, neighbor) and not self.outside_boundary(neighbor) and neighbor not in self.explored_set and not self.inside_obstacles(snake,neighbor):
